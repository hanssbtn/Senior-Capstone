	...
	\subsection{Computer Aided Design}
		\begin{indentedblock}{4em}{0pt}
			...
			\begin{figure}[!ht]
				...
				\vspace{0.2cm} % Add a small gap
%				\begin{minipage}{0.70\linewidth} % Keeps text width aligned with image
%					\footnotesize % Notes are usually a bit smaller
%					
%				\end{minipage}
...
\begin{indentedblock}{4em}{0pt}
	...
	\begin{enumerate}
		...
		\item {
			Accurately translate geometric data (points, lines, shapes) into human language.
		}
		\item {
