...
\begin{indentedblock}{4em}{0pt}
	...
	\begin{enumerate}
		...
		\item {
			Translating low-level B-Rep topology into high-level semantic concepts with $>80\%$ identification accuracy as measured with BERTScore and BLEU measures.
		}
		\item {
