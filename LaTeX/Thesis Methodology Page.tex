...
\section{Model Design}
	...
	\subsection{Tokenizer Architecture}
		\begin{indentedblock}{4em}{0pt}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=\linewidth]{../Images/TikZ/TOKENIZER.pdf}
...
\section{Training and Evaluation}
	\subsection{Training Setup: Causal Language Modeling}
		\begin{indentedblock}{4em}{0pt}
			...
			\textbf{Instruction Tuning Format:}
			To structure the generation, the input is formatted as a prompt-response pair:
			\begin{equation}
	...
	\subsection{Evaluation Metrics}
		\subsubsection{Metric Definition and Evaluation Thresholds}
			\begin{indentedblock}{4em}{0pt}
				...
				\begin{table}[H]
					\centering
					\small % Slightly smaller text to fit the math comfortably
					\begin{tblr}{
							width=\linewidth,
							colspec={
		...
		\subsubsection{Harmonization of Divergent Metrics}
			\begin{indentedblock}{4em}{0pt}
				It is recognized in Natural Language Generation (NLG) literature that semantic metrics (BERTScore) and $n$-gram metrics (BLEU) can exhibit an inverse correlation; increasing the "creativity" of a model often improves semantic flow at the cost of exact word matching. To resolve this tension and ensure robust evaluation, this research implements a \textbf{Hierarchical Metric Prioritization} strategy that aligns specific metrics with the annotation levels defined in \autoref{tab:annotation-levels} as defined below:
