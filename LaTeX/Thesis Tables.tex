...
\setlength{\cftbeforetoctitleskip}{-21bp}       % Pulls up ToC
\setlength{\cftbeforeloftitleskip}{-21bp}       % Pulls up LoF
\setlength{\cftbeforelottitleskip}{-21bp}       % Pulls up LoT
\setlength{\cftbeforeloetitleskip}{-21bp}  % Pulls up your custom Formulas list
